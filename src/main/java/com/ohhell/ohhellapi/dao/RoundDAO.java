...
public class RoundDAO {
    ...
    public Round createRound(Round round) throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (round.getTrump() != null) {
                pstmt.setString(4, round.getTrump().getSuit().name());
                pstmt.setString(5, round.getTrump().getRank().name());
            } else {
    ...
    public boolean updateRound(Round round) throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (round.getTrump() != null) {
                pstmt.setString(1, round.getTrump().getSuit().name());
                pstmt.setString(2, round.getTrump().getRank().name());
            } else {
